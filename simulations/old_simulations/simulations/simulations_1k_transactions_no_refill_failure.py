...
filename = 'simulations_1k_transactions_no_refill_failure.json'
f = open(filename)
data = json.load(f)
...
plt.title('Market gain doing n transactions with a certain interest, with market refill but without refill failure')
